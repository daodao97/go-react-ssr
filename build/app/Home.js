...
function Home({ message = "", initialCount = 0 }) {
  ...
  return /* @__PURE__ */ import_react3.default.createElement(p, { gap: "3", className: "flex-1 flex-col" }, /* @__PURE__ */ import_react3.default.createElement(Hero, null), /* @__PURE__ */ import_react3.default.createElement(Faq, null));
}
