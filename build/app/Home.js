...
// frontend/blocks/hero/Hero.tsx
function Hero({ hero }) {
  return /* @__PURE__ */ import_react2.default.createElement("section", { className: "bg-gradient-to-r from-indigo-600 to-purple-600 py-16 px-4 sm:px-6 lg:px-8 shadow-xl" }, /* @__PURE__ */ import_react2.default.createElement("div", { className: "max-w-4xl mx-auto text-center" }, /* @__PURE__ */ import_react2.default.createElement("h1", { className: "text-4xl sm:text-5xl font-extrabold  mb-6 tracking-tight" }, hero.title), hero.buttons && /* @__PURE__ */ import_react2.default.createElement("div", { className: "flex flex-wrap justify-center gap-3 mb-8" }, (hero.buttons || []).map((button, index) => /* @__PURE__ */ import_react2.default.createElement(
    "a",
    {
      key: index,
      href: button.href,
      ...
      rel: button.rel,
      className: button.overwirteClassName ? button.overwirteClassName : twMerge(
